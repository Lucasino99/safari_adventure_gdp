...
public class AIController : MonoBehaviour
{
    ...
    public Animator animator;                       //to control the animations of our enemy
    public AudioSource runAudioSource;              //to control the walking audio of our enemy
    public float damage = 10f;                      // Amount of damage enemy does to player
    ...
    void Start()
    {
        ...
        animator = GetComponent<Animator>();        //reference to animator controller
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            // Call the TakeDamage function in the PlayerHealth script
